\begin{abstract}{swedish}
  Avsikten med detta arbete är att redogöra för implementationen av ett system
  ...
  Olika sätt att göra bedömningar om besökare på en webbsida studeras. Med den information systemet kan samla in om en besökare
  definieras filtertyper som kan användas för att filtrera innehåll på basis av
  informationen.

  Utöver detta redogörs för den tekniska arkitektur som valts ut för systemet,
  samt hur de val som gjorts vid planeringen stöder systemets funktionalitet.
...
\begin{abstract}{english}
  ...
  website administrators to easily utilize personalization of web content.
  ...
  The technical architecture behind the system is also presented. Some of the choices
  made during the design of the architecture, and the impact of these choices,
  are also presented.

  Finally a list of proposed areas of furher development is presented, documenting areas
