...
Motivationen för att implementera stadsfiltret kom från iden om att en användare kan köra kampanjer för olika kontor i olika städer eller visa kontorsspecifika öppethållningstider.
