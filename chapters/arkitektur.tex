...
När en förfrågan kommer in, kallas en factory\todo{förklara factory} metod som försöker hitta besökaren i statistikdatabasen. Om ett resultat hittas, uppdaterar factory metoden det befintliga objektet med den nya informationen från förfrågningen. Om besökaren inte är igenkänd så skapas ett nytt besökarobjekt med den försedda informationen.

\subsubsection{Site objektet}

\input{assets/uml/site}

Sidobjektet är det högsta objektet i hierarkin. \todo{Förklara att vi talar om hierarkin för filtrering} det beskriver användarens webbplats i sin helhet. Från sidobjektet går alla relationer enda ner till filtren som används för att välja ut innehåll.
